...
public class CraftingManager {
	...
	public static void reg2() {
		...
		addRecipeAuto(new ItemStack(ModBlocks.dfc_exchanger, 1), "SCS", "HMP", "SCS", 'S', OSMIRIDIUM.ingot(), 'C', ModItems.plate_combine_steel, 'H', ModBlocks.heater_heatex, 'M', ModItems.motor, 'P', ModItems.pipes_steel);
